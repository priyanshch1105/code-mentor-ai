    ...
    return ListView(
      ...
      children: [
        Wrap(
          ...
          runSpacing: 8,
          children: [
            _Pill(icon: Icons.bug_report_outlined, text: 'Debug', selected: true),
        ...
        SectionCard(
          child: Column(
            ...
            children: [
              Text('Code Input', style: theme.textTheme.titleMedium?.copyWith(fontWeight: FontWeight.w700)),
              const SizedBox(height: 10),
              Container(
                height: 190,
              ...
              Row(
                children: [
                  FilledButton.icon(onPressed: () {}, icon: const Icon(Icons.play_arrow), label: const Text('Analyze')),
                  const SizedBox(width: 8),
                  OutlinedButton.icon(onPressed: () {}, icon: const Icon(Icons.play_circle_outline), label: const Text('Run')),
                  const SizedBox(width: 8),
                  OutlinedButton.icon(onPressed: () {}, icon: const Icon(Icons.history), label: const Text('History')),
                ],
              ),
            ],
          ),
