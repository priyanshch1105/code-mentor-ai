      ...
      children: [
        SectionCard(
          child: Column(
            ...
            children: [
              Text('Start New Quiz', style: theme.textTheme.titleMedium?.copyWith(fontWeight: FontWeight.w700)),
              const SizedBox(height: 10),
              Row(
                children: [
                  Expanded(child: _MetaBox(label: 'Subject', value: 'Data Structures')),
                  const SizedBox(width: 8),
                  Expanded(child: _MetaBox(label: 'Difficulty', value: 'Beginner')),
                ],
              ),
              const SizedBox(height: 10),
              FilledButton.icon(
        ...
        SectionCard(
          child: Column(
            ...
            children: [
              Row(
                children: [
                  Text('Active Quiz', style: theme.textTheme.titleMedium?.copyWith(fontWeight: FontWeight.w700)),
                  const Spacer(),
        ...
        SectionCard(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('Recommendations', style: theme.textTheme.titleMedium?.copyWith(fontWeight: FontWeight.w700)),
              const SizedBox(height: 10),
              const _RecommendationItem(
                title: 'Priority: Arrays revision quiz',
                subtitle: 'Your last 2 attempts had low accuracy in indexing questions.',
              ),
              const SizedBox(height: 8),
              const _RecommendationItem(
                title: 'Try intermediate recursion set',
                subtitle: 'You have completed beginner recursion in 3 sessions.',
              ),
            ],
          ),
        ),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        color: selected ? theme.colorScheme.primary.withValues(alpha: 0.09) : null,
      ),
      child: Text(text),
    );
  }
